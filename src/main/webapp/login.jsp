...
<body>
	<c:choose>
		<c:when test="${WrongCredentials == 'Retry Login'}">
			<div class="alert alert-danger alert-dismissable fade in">
				<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
				<div class="innerText" style="text-align: center">
					<strong>Wrong Username or Password!</strong> Try to log in again.
				</div>
			</div>
		</c:when>
	</c:choose>
	...
	<div class="wrapper">
		<form class="login" method="post" action="login.do">
			...
			<button name="submit" value="login">
				<i class="spinner"></i> <span class="state">Log Me In</span>
			</button>
		</form>
	</div>
</body>
